...
import {
    onOpenModalInvCategoria,
    onOpenModalStockInvCategoria,
} from "../../../store/inventario/categoria/uiInvCategoriaSlice";

export const useInvUiCategoria = () => {
    const { isOpenModalInvCategoria, isOpenModalStockInvCategoria } =
        useSelector((state) => state.uiInvCategoria);
